...
--**Future work **
A per-clip mute for original audio (so the user can silence footage and keep only the added music) is a natural extension of the balance slider. Deferred to keep the audio path stable inside the deadline.
